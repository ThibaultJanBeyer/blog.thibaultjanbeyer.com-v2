---
layout: post
title: a jQuery Carousel Slider
excerpt: Here you go, my first tool on Github even
image: /assets/carousel-slider.png
image_alt: Carousel Slider
---

<blockquote>Type: Private<br />
Skills: jQuery, Javascript<br />
Year: 2015</p></blockquote>
...
<h3 style="color: white;">Page 1</h3>
</div>
<div class="slide" style="background: #34495e; color: white; padding: 20px;">
<h3 style="color: white;">Page 2</h3>
</div>
<div class="slide" style="background: #27ae60; color: white; padding: 20px;">
<h3 style="color: white;">Page 3</h3>
</div>
</div>
<div class="arrow left"></div>
<div class="arrow right"></div>
<p class="pause" style="position: absolute; color: white; right: 20px; bottom: 0;">Pause</p>
<p class="play" style="position: absolute; color: white; right: 20px; bottom: 0;">Play</p>
</div>
<p>What I describe here is version 0.1.0.<br />
On your right you see a live demo:<br />
Features:<br />
- Use your own navigation arrows<br />
- Set options in html only<br />
- keyboard navigation<br />
- New cool awesome features I don't know yet will be added every now and then, check out the slider's page!</p>
